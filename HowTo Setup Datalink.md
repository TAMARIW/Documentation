This guide is for seting up and building the datalink section of the raspberry pi. Please follow the Raspberry Pi Setup to install requirements and setup the networking for the datalink.
